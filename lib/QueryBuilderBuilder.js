!function() {
    ...
    var QueryBuilderBuilder = module.exports = new Class({
        ...
        , _setDefault: function(ClassDefinition) {
            ...
            ClassDefinition._list.offsetBuilder = this.definition.methods.list.offsetHandler.buildRequest.bind(this.definition.methods.list.offsetHandler);
            ClassDefinition._list.limitBuilder = this.definition.methods.list.limitHandler.buildRequest.bind(this.definition.methods.list.limitHandler);
        }
    });
}();
